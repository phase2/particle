export declare enum CSSLibraryOptions {
    TAILWIND = "tailwind",
    SASS = "sass",
    BOOTSTRAP = "bootstrap"
}
export declare enum ComponentLibraryOptions {
    STORYBOOK = "storybook",
    PATTERN_LAB = "pattern_lab"
}
export declare enum FrontendFrameworkOptions {
    TWIG = "twig",
    REACT = "react",
    WEBCOMPONENTS = "webcomponents"
}
export declare enum ConfigOptions {
...
export declare enum TestingLibraryOptions {
    CYPRESS = "cypress",
    JEST = "jest",
    LOKI = "loki",
    PA11Y = "pa11y",

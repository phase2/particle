...
const namespaces = {
  ...
  transform: folderPath => {
    ...
    return {
      // System specific component path e.g. user/themes/particle/dist/app-grav/assets/atomic/_patterns/01-atoms/badge
      ...
      relativePath: path.join(appDistPath, ASSETS_ATOMIC_FOLDER, patternPath),
    };
  },
};
